...
const tmdbApi = {
    ...
    mediaDetalis : async ({mediaType,mediaId}) => await axiosClient.get(
    ...
    mediaImage : async ({mediaType,mediaId}) => await axiosClient.get(
        tmdbEndpoints.mediaImage({mediaType,mediaId})
    ),
