...
const ScrollAppBar = ({ children, window }) => {
    ...
    return cloneElement(children, {
        sx: {
            color: trigger ? "text.primary" : themeMode === themeModels.dark ? "primary.contrastText" : "text.primary",
            backgroundColor: trigger ? "background.paper" : themeMode === themeModels.dark ? "transparent" : "background.paper"
        }
    });
};
...
const Topbar = () => {
    ...
    const onSwithTheme = () => {
        const theme = themeMode === themeModels.dark ? themeModels.light : themeModels.dark;
            ...
            <AppBar elevation={0} sx={{ zIndex: 9999 }}>
                <Toolbar sx={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <Box flexGrow={1} alignItems="center" display={{ xs: "none", md: "flex" }}>
                        ...
                        >
                            {themeMode === themeModels.dark && <DarkModeOutlinedIcon />}
                            {themeMode === themeModels.light && <WbSunnyOutlinedIcon />}
                        </IconButton>
                    </Box>
